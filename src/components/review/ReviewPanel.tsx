        ...
        <aside className="w-full self-start text-start rounded-[10px] bg-brand-baby-blue p-3.75 lg:sticky lg:top-4 lg:w-1/3">
            ...
            {!isCheckoutDisabled && <div className="mt-5">
                ...
                <button
                    ...
                    className="mt-5 w-full rounded-sm bg-brand-purple px-4 py-3 text-[17px] font-semibold text-white hover:saturate-150 transition duration-150 cursor-pointer active:scale-[0.99]"
                >
                    {t('checkout')}
                </button>
